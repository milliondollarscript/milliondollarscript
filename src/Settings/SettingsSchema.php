...
final class SettingsSchema {
    ...
    public static function groups() {
        return [
            ...
            __('URLs & Redirects', 'million-dollar-script') => [
                ...
                ['key' => 'mds-pixel-slug-structure', 'label' => __('Advertiser Page Slug Pattern', 'million-dollar-script'), 'type' => 'text', 'default' => '%placement_id%', 'description' => __('Supports %placement_id%, %pixel_id%, %order_id%, %grid%, %title%, %text%, and %alt_text%. %title% and %text% resolve to the ad display text (alt text when set, otherwise popup text); %alt_text% resolves to the raw alt text. Account-name tokens from Million Dollar Script 2 resolve to blank for privacy.', 'million-dollar-script')],
                ['key' => 'advertiser-page-popup-link', 'label' => __('Link Popups To Advertiser Pages', 'million-dollar-script'), 'type' => 'select', 'default' => 'yes', 'options' => ['yes', 'no'], 'description' => __('Adds a full-page action to built-in placement popups. It links to the public advertiser page, or to the mapped MDS2 pixel page while MDS 3.0 pages are disabled.', 'million-dollar-script')],
            ...
            __('Display & Interaction', 'million-dollar-script') => [
                ...
                [
                    ...
                    'description' => __('Optional HTML layout for occupied block popups. Supports %title%, %text%, %url%, %image%, %alt_text%, %advertiser_page_url%, and %advertiser_page_link%. %title% resolves to the ad display text (alt text when set, otherwise popup text). This changes presentation only; it does not add, remove, or require customer input fields. Leave blank to use the built-in layout.', 'million-dollar-script'),
                ],
            ],
    ...
    public static function help($key) {
        $help = [
            ...
            'advertiser-page-popup-link' => __('Adds a full-page action to built-in placement popups. It links to the public advertiser page, or to the mapped MDS2 pixel page while MDS 3.0 pages are disabled.', 'million-dollar-script'),
