(function ($) {
	...
	function mds_nfs_refresh(data, message, dfd) {
		$(document).find('.outer_box').replaceWith(data).promise().done(function () {
	...
	function handleResponse(response) {
		...
		try {
			if (response.success) {
				mds_nfs_refresh(response.data, MDS.lang.success, dfd);
			} else {
