...
' )
			...
			Language::get( 'System' ) => [
				...
				Field::make( 'text', MDS_PREFIX . 'extension_server_url', Language::get( 'Extension Server URL' ) )
					->set_default_value( 'https://milliondollarscript.com' )
					->set_help_text( Language::get( 'The URL of the extension server for automatic updates and downloads. Use http://extension-server-go:8080 or http://localhost:8080 for development or your production server URL. Default: https://milliondollarscript.com' ) ),
				...
				Field::make( 'select', MDS_PREFIX . 'updates', Language::get( 'Plugin updates' ) )
					...
					->set_options( [
						...
						->set_help_text( Language::get( '<strong>Don\'t update</strong> - No updates will be searched for or installed for this plugin. Use this if custom changes have been made to the plugin code. Updates should be merged in manually.<br /><br /><strong>Stable</strong> - Production-ready releases with thoroughly tested code. Recommended for all sites. Updates occur when new stable versions are released through the Million Dollar Script extension server. Sites previously set to beta or alpha now receive stable releases: the separate pre-release channels are no longer maintained.<br /><br /><span style="color: red">Always backup your files and database before updating. Test thoroughly and report any issues you find.</span>' ) ),
